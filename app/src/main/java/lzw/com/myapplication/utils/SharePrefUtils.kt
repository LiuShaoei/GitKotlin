...
class SharePrefUtils<T>(val name: String, private val default: T) {
    private val prefs: SharedPreferences by lazy { MyApp.instance!!.getSharedPreferences(name, Context.MODE_PRIVATE) }
